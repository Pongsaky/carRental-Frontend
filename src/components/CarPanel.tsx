...
export default function CarPanel() {
  ...
  // const mockCarRepo = [
  //   { cid: "001", name: "Honda Civic", img: "/img/civic.jpg" },
  //   { cid: "002", name: "Honda Accord", img: "/img/accord.jpg" },
  //   { cid: "003", name: "Toyota Fortuner", img: "/img/fortuner.jpg" },
  //   { cid: "004", name: "Tesla Model 3", img: "/img/tesla.jpg" },
  // ];
